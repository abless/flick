...
#define __STD_C 0	/* special for Flick */
...
#else
#include <types.h>	/* modified for Flick */
#endif
...
#define MALLOC_FAILURE_ACTION 0	/* Flick doesn't have a errno.h yet */
...
extern unsigned long getpagesize();
